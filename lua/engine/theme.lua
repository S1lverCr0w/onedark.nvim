...
theme.setup = function(cfg)
    ...
    hi.plugins = {
        ...
        BlinkCmpSource = { fg = c.fg_gutter },

        -- Kind icons: link straight to the equivalent Cmp* groups you already have,
        -- so both nvim-cmp and blink.cmp stay visually consistent with zero extra colors
